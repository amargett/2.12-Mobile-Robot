                                ...
                                spline_type type)
        {
            ...
            else if (type == cspline_hermite)
            {
                ...
                else if (m_left == not_a_knot)
                {
                    ...
                    m_b[0] = -m_b[1] + 2.0 * (m_y[1] - m_y[0]) / h0 + h0 * h0 / (h1 * h1) * (m_b[1] + m_b[2] - 2.0 * (m_y[2] - m_y[1]) / h1);
                }
                else
                {
                    assert(false);
                ...
                else if (m_right == not_a_knot)
                {
                    ...
                    m_b[n - 1] = -m_b[n - 2] + 2.0 * (m_y[n - 1] - m_y[n - 2]) / h1 + h1 * h1 / (h0 * h0) * (m_b[n - 3] + m_b[n - 2] - 2.0 * (m_y[n - 2] - m_y[n - 3]) / h0);
